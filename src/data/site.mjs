...
export const SERVICES = [
  ...
  { slug: 'web-development', cat: 'digital', name: 'Web Development', short: 'Scalable web apps & platforms', icon: 'globe', photo: '1619410283995-43d9134e7656' },
  ...
  { slug: 'custom-software', cat: 'digital', name: 'Custom Software', short: 'Bespoke enterprise solutions', icon: 'blocks', photo: '1461749280684-dccba630e2f6' },
  ...
  { slug: 'saas-development', cat: 'digital', name: 'SaaS Development', short: 'Multi-tenant SaaS platforms', icon: 'layers', photo: '1460925895917-afdab827c52f' },

  { slug: 'generative-ai', cat: 'ai', name: 'Generative AI', short: 'LLM apps & AI automation', icon: 'bot', photo: '1485827404703-89b55fcc595e' },
  { slug: 'ar-vr-xr', cat: 'ai', name: 'AR / VR / XR', short: 'Immersive experiences & metaverse', icon: 'glasses', photo: '1552871419-81ba9b1aa9c9' },
  ...
  { slug: 'data-analytics', cat: 'ai', name: 'Data Analytics', short: 'BI, pipelines & dashboards', icon: 'chart-column', photo: '1551288049-bebda4e38f71' },

  { slug: 'cloud-applications', cat: 'cloud', name: 'Cloud Applications', short: 'AWS, GCP, Azure-native builds', icon: 'cloud', photo: '1644088379091-d574269d422f' },
  { slug: 'cloud-migration', cat: 'cloud', name: 'Cloud Migration', short: 'Lift, shift & modernization', icon: 'cloud-upload', photo: '1558494949-ef010cbdcc31' },
  { slug: 'devops-ci-cd', cat: 'cloud', name: 'DevOps & CI/CD', short: 'Pipelines & infrastructure', icon: 'infinity', photo: '1607799279861-4dd421887fb3' },
  { slug: 'cybersecurity', cat: 'cloud', name: 'Cybersecurity', short: 'Security audits & hardening', icon: 'shield-check', photo: '1526374965328-7f61d4dc18c5' },
  { slug: 'cloud-maintenance', cat: 'cloud', name: 'Cloud Maintenance', short: 'Monitoring & optimization', icon: 'activity', photo: '1526628953301-3e589a6a8b74' },

  { slug: 'salesforce-consulting', cat: 'crm', name: 'Salesforce Consulting', short: 'Implementation & optimization', icon: 'cloud-cog', photo: '1517048676732-d65bc937f952' },
  { slug: 'salesforce-development', cat: 'crm', name: 'Salesforce Development', short: 'Apex, LWC & AppExchange', icon: 'code', photo: '1534665482403-a909d0d97c67' },
  { slug: 'hubspot-crm', cat: 'crm', name: 'HubSpot CRM', short: 'Sales, marketing & service hubs', icon: 'magnet', photo: '1599658880436-c61792e70672' },
  ...
  { slug: 'crm-integration', cat: 'crm', name: 'CRM Integration & Migration', short: 'Connect, migrate & clean data', icon: 'git-merge', photo: '1504868584819-f8e8b4b6d7e3' },

  { slug: 'staff-augmentation', cat: 'specialized', name: 'Staff Augmentation', short: 'Embed expert engineers', icon: 'users', photo: '1606857521015-7f9fcf423740' },
  { slug: 'quality-assurance', cat: 'specialized', name: 'Quality Assurance', short: 'Testing & QA automation', icon: 'badge-check', photo: '1569012871812-f38ee64cd54c' },
  ...
  { slug: 'art-design', cat: 'specialized', name: 'Art & Design', short: '3D art, animation, concept', icon: 'palette', photo: '1561070791-2526d30994b5' },
  { slug: 'maintenance-support', cat: 'specialized', name: 'Maintenance & Support', short: 'Ongoing system care', icon: 'wrench', photo: '1581092918056-0c4c3acd3789' },
  { slug: 'automation-apps', cat: 'specialized', name: 'Automation & Apps', short: 'Workflow & process bots', icon: 'zap', photo: '1531746790731-6c087fecd65a' },
];
